...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, removeResponseHeader, getQuery as getQuery$1, readBody, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, getResponseStatusText } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL, decodePath, withLeadingSlash, withoutTrailingSlash } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/vue/index.mjs';
import BaseStyle from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primevue/core/base/style/index.mjs';
import BaseComponentStyle from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primevue/core/basecomponent/style/index.mjs';
import { style } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/autocomplete/index.mjs';
import { isNotEmpty, isEmpty } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/utils/dist/object/index.mjs';
import { style as style$1 } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/cascadeselect/index.mjs';
import { style as style$2 } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/checkbox/index.mjs';
import { style as style$3 } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/checkboxgroup/index.mjs';
import { style as style$4 } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/colorpicker/index.mjs';
import { style as style$5 } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/datepicker/index.mjs';
import { style as style$6 } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/floatlabel/index.mjs';
import { style as style$7 } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/iconfield/index.mjs';
import { style as style$8 } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/iftalabel/index.mjs';
import { style as style$9 } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/inputchips/index.mjs';
import { style as style$a } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/inputgroup/index.mjs';
import { style as style$b } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/inputnumber/index.mjs';
import { style as style$c } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/inputotp/index.mjs';
import { style as style$d } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/inputtext/index.mjs';
import { style as style$e } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/knob/index.mjs';
import { style as style$f } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/listbox/index.mjs';
import { style as style$g } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/multiselect/index.mjs';
import { style as style$h } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/password/index.mjs';
import { style as style$i } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/radiobutton/index.mjs';
import { style as style$j } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/radiobuttongroup/index.mjs';
import { style as style$k } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/rating/index.mjs';
import { style as style$l } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/select/index.mjs';
import { style as style$m } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/selectbutton/index.mjs';
import { style as style$n } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/slider/index.mjs';
import { style as style$o } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/textarea/index.mjs';
import { style as style$p } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/togglebutton/index.mjs';
import { style as style$q } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/toggleswitch/index.mjs';
import { style as style$r } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/treeselect/index.mjs';
import { style as style$s } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/button/index.mjs';
import { style as style$t } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/buttongroup/index.mjs';
import { style as style$u } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/speeddial/index.mjs';
import { style as style$v } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/splitbutton/index.mjs';
import { style as style$w } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/datatable/index.mjs';
import { style as style$x } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/dataview/index.mjs';
import { style as style$y } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/orderlist/index.mjs';
import { style as style$z } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/organizationchart/index.mjs';
import { style as style$A } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/paginator/index.mjs';
import { style as style$B } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/picklist/index.mjs';
import { style as style$C } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/tree/index.mjs';
import { style as style$D } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/treetable/index.mjs';
import { style as style$E } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/timeline/index.mjs';
import { style as style$F } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/virtualscroller/index.mjs';
import { style as style$G } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/accordion/index.mjs';
import { style as style$H } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/card/index.mjs';
import { style as style$I } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/divider/index.mjs';
import { style as style$J } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/fieldset/index.mjs';
import { style as style$K } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/panel/index.mjs';
import { style as style$L } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/scrollpanel/index.mjs';
import { style as style$M } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/splitter/index.mjs';
import { style as style$N } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/stepper/index.mjs';
import { style as style$O } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/tabview/index.mjs';
import { style as style$P } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/tabs/index.mjs';
import { style as style$Q } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/toolbar/index.mjs';
import { style as style$R } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/confirmdialog/index.mjs';
import { style as style$S } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/confirmpopup/index.mjs';
import { style as style$T } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/dialog/index.mjs';
import { style as style$U } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/drawer/index.mjs';
import { style as style$V } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/popover/index.mjs';
import { style as style$W } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/fileupload/index.mjs';
import { style as style$X } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/breadcrumb/index.mjs';
import { style as style$Y } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/contextmenu/index.mjs';
import { style as style$Z } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/dock/index.mjs';
import { style as style$_ } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/menu/index.mjs';
import { style as style$$ } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/menubar/index.mjs';
import { style as style$10 } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/megamenu/index.mjs';
import { style as style$11 } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/panelmenu/index.mjs';
import { style as style$12 } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/steps/index.mjs';
import { style as style$13 } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/tabmenu/index.mjs';
import { style as style$14 } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/tieredmenu/index.mjs';
import { style as style$15 } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/message/index.mjs';
import { style as style$16 } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/inlinemessage/index.mjs';
import { style as style$17 } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/toast/index.mjs';
import { style as style$18 } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/carousel/index.mjs';
import { style as style$19 } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/galleria/index.mjs';
import { style as style$1a } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/image/index.mjs';
import { style as style$1b } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/imagecompare/index.mjs';
import { style as style$1c } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/avatar/index.mjs';
import { style as style$1d } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/badge/index.mjs';
import { style as style$1e } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/blockui/index.mjs';
import { style as style$1f } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/chip/index.mjs';
import { style as style$1g } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/inplace/index.mjs';
import { style as style$1h } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/metergroup/index.mjs';
import { style as style$1i } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/overlaybadge/index.mjs';
import { style as style$1j } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/scrolltop/index.mjs';
import { style as style$1k } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/skeleton/index.mjs';
import { style as style$1l } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/progressbar/index.mjs';
import { style as style$1m } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/progressspinner/index.mjs';
import { style as style$1n } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/tag/index.mjs';
import { style as style$1o } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/terminal/index.mjs';
import FormStyle from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primevue/forms/form/style/index.mjs';
import FormFieldStyle from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primevue/forms/formfield/style/index.mjs';
import { style as style$1p } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/tooltip/index.mjs';
import { style as style$1q } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styles/dist/ripple/index.mjs';
import { Theme } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/@primeuix/styled/dist/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, isAbsolute } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/unhead/dist/utils.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/node_modules/ipx/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/public"
      ]
    },
    "http": {
      "domains": []
...
const _CpVAWf2q6O0VlkMQloS8aJNzYEv4GrJWW6YvdF7IBoA = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web";
...
const _JWSukgVQMoJbrcJkhKQPgBkQyR01QA4uD89Ap1fQB0I = (nitroApp) => {
...
const _pqUYFnis3cxkczPtJ7jPnaz9rXv1IxTJljvFbeCB3qU = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _CpVAWf2q6O0VlkMQloS8aJNzYEv4GrJWW6YvdF7IBoA,
_JWSukgVQMoJbrcJkhKQPgBkQyR01QA4uD89Ap1fQB0I,
_pqUYFnis3cxkczPtJ7jPnaz9rXv1IxTJljvFbeCB3qU
];

const assets = {
  "/index.mjs": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"7fbf4-0lqZzUN/glp0wGNaSUgIrBxr1sU\"",
    "mtime": "2026-03-23T23:34:58.241Z",
    "size": 523252,
    "path": "index.mjs"
  },
  "/index.mjs.map": {
    "type": "application/json",
    "etag": "\"1ff75b-Kos9YswPbQcCogGXXBBMvbtL4r0\"",
    "mtime": "2026-03-23T23:34:58.244Z",
    "size": 2094939,
    "path": "index.mjs.map"
  }
};
...
const _XXf43p = eventHandler((event) => {
...
const getServerEntry = () => import('file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file:///Users/marceloamagalhaes/dev/sirius-eco-system/siriusstudio/web/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
const _q2DkPO = lazyEventHandler(() => {
...
const _lazy_uk1VjH = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _XXf43p, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_uk1VjH, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _q2DkPO, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_uk1VjH, lazy: true, middleware: false, method: undefined }
];
