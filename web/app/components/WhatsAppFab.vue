<template>
  <div class="fixed bottom-6 right-6 z-[2000] flex flex-col items-end gap-3">
    <div 
      class="bg-white text-[#4a3728] px-4 py-2 rounded-lg shadow-xl text-sm font-serif italic border border-[#d1b253]/20 transition-all duration-500 opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 hidden md:block"
      id="whatsapp-tooltip"
    >
...
<style scoped>
/* Estilização extra se necessário */
.group:hover #whatsapp-tooltip {
  opacity: 1;
