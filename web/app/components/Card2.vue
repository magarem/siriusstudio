<template>
  <div class="card-horizontal-video">
    ...
    <div class="flex flex-col lg:flex-row gap-6 lg:gap-[50px] p-4 lg:p-1 bg-transparent rounded-xl transition-shadow duration-300">
      ...
      <div class="lg:w-1/2 ">
        <div class="mt-7 rounded-[20px] relative w-full h-75 md:h-190 lg:h-[330px]  overflow-hidden shadow-md">
          <!-- Container do vídeo -->
          <div 
            v-if="videoId"
            class="w-full h-full bg-gray-900 cursor-pointer "
            @click="playVideo"
          >
            ...
            <div class="relative w-full h-full ">
              ...
              <div class="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center hover:bg-opacity-20 transition-all duration-300">
      ...
      <div class="lg:w-1/2 flex flex-col">
        <!-- Título em branco -->
        <h2 class="text-2xl md:text-[40px] font-bold text-white mb-9 ">
          {{ title }}
        </h2>
        
        <!-- Texto descritivo em branco -->
        <div class="text-white mb-6 flex-grow">
          <p class="leading-relaxed text-base md:text-[20px]">
            {{ description }}
          </p>
